...
import { CategoriasCatalogoServicesService } from "src/app/core/services";
// Sweet Alert
...
export class CategoriasComponent {
  ...
  constructor(
    ...
    private service: CategoriasCatalogoServicesService,
  ...
  editarRegistro(content: any, id_: any) {
    var data = this.listado.filter((e: any) => e.id_categoria == id_);
